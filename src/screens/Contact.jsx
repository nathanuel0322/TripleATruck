                    ...
                    <div className="first-element mbr-col-md-12 mbr-col-sm-12 mbr-column mbr-flex mbr-jc-c mbr-col-lg-6">
                        <div className="contacts-block mbr-pb-4 mbr-flex mbr-jc-c mbr-column">
                            <div className="contacts-box">
                                <p className="mbr-fonts-style mbr-white mbr-pb-3 display-4"></p>
                                <div className="mbr-flex mbr-pb-1 mbr-ai-e">
                                    ...
                                    <div className="cont-text-box mbr-white">
                                        <p className="mbr-fonts-style contacts-title display-4">Phone</p>
                                        <p className="mbr-fonts-style mbr-bold contacts-info display-4">+1 718-673-8529</p>
                                    </div>
                                </div>
                                <div className="mbr-flex mbr-ai-e">
                                    <div className="icon-box">
                                        <div className="iconfont-wrapper icon-wrapper2">
                                    ...
                                    <div className="cont-text-box mbr-white">
                                        <p className="mbr-fonts-style contacts-title display-4">E-Mail</p>
                                        <p className="mbr-fonts-style mbr-bold contacts-info display-4">tbnd@prestigiousgamingonwheelsplus.com</p>
                                    </div>
                                </div>
                                <div className="icons-list social mbr-pt-4">
                        ...
                        <div className="" data-form-type="formoid">
                            <form className="mbr-form i-amphtml-form" id="contactme" onSubmit={sendEmail}>
                                <div className="dragArea mbr-form-row-con">
                                    ...
                                    <div className="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12 field">
                                    ...
                                    <div className="mbr-col mbr-col-md-12 mbr-col-sm-12 mbr-section-btn align-center field" id="sendform">
