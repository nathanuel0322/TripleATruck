                            ...
                            <div className="contacts-box">
                                ...
                                <div className="flex pb-1 ai-e">
                                    ...
                                    <div className="cont-text-box white">
                                        ...
                                        <a href='tel:...' style={{textDecoration: 'underline'}} className="fonts-style bold contacts-info display-4">...</a>
                                    </div>
                                </div>
                                <div className="flex ai-e">
                                    ...
                                    <div className="cont-text-box white">
                                        ...
                                        <a href='mailto:...' style={{textDecoration: 'underline'}} className="fonts-style bold contacts-info display-4">...</a>
                                    </div>
                                </div>
